...
#XML Audio configuration files (CAF)
PRODUCT_COPY_FILES += \
...
# Invdividual audio configs (TODO: move to specific device)
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/keylayout/hall-switch-input.kl:system/usr/keylayout/hall-switch-input.kl \
...
# Lights (he is not ready for build)
#PRODUCT_PACKAGES += \
#    lights.msm8953
